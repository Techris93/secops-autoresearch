...
def export_agent_and_session_hooks() -> tuple[list[dict[str, Any]], list[dict[str, Any]], list[dict[str, Any]]]:
        ...
        config_events.append(
            {
                ...
                "actor": "openclaw",
                "changedPaths": row.get("suspicious") or ["openclaw.json"],
                "note": row.get("event"),
...
def main() -> None:
    ...
    agent_events, session_hooks, subagent_hooks = export_agent_and_session_hooks()
